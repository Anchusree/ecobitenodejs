...
const { getAllUsers, getAllRestaurants, getOneRestaurant, getAdminDashboard, manageNotofications } = require("../../controllers/admin/adminManageUsers")
...
adminRouter.get("/admin/getAllRestOrders",getAllRestOrders)
